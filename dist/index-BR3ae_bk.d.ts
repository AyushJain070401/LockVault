type Algorithm = 'HS256' | 'RS256' | 'ES256' | 'ES384' | 'ES512' | 'EdDSA';
...
export { type AccessTokenPayload as A, type CookieOptions as C, type DatabaseAdapter as D, type KeyValueStore as K, type LockVaultConfig as L, type MiddlewareOptions as M, type OAuthProviderPreset as O, type RateLimitConfig as R, type Session as S, type TOTPSetupResult as T, type TOTPConfig as a, type OAuthProviderConfig as b, type OAuthUserProfile as c, type OAuthTokenResponse as d, type OAuthLink as e, type DeviceInfo as f, type TokenPair as g, type Algorithm as h, AuthErrorCode as i, type AuthUser as j, type DecodedToken as k, type LockVaultHooks as l, type LockVaultPlugin as m, type RefreshTokenPayload as n, type TokenPayload as o };
